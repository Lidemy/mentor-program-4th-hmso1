...
app.get('/add-article', userController.isLogin, categoryController.getCategory, articleController.addArticle);
app.post('/add-article', categoryController.handleAddCategory, articleController.handleAddArticle);
